...
tf.app.flags.DEFINE_string('VOC_dir', '/home/konghaiyang/lm/FPN_Tensorflow/data/icecream_train/', 'Voc dir')
...
tf.app.flags.DEFINE_string('dataset', 'icecream', 'dataset')
        ...
        if child_of_root.tag == 'object':
            ...
            for child_item in child_of_root:
                if child_item.tag == 'name':
                    # cit = child_item.text.strip().encode('utf-8')
